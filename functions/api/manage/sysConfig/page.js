...
export async function getPageConfig(db, env) {
    ...
    config.push(
        ...
        },
        {
            ...
            tooltip: '自定义URL前缀，如：https://img.a.com/p/ 或 https://img.a.com/e/，留空则使用当前域名 <br/> 设置后将应用于客户端和管理端 <br/> 该选项用于CDN加速等场景，请确保自定义前缀可访问',
            tooltip_en: 'Custom URL prefix, e.g. https://img.a.com/p/ or https://img.a.com/e/. Leave empty to use current domain <br/> Applies to both client and admin <br/> This option is intended for scenarios such as CDN acceleration. Make sure the custom prefix is accessible',
            category: '全局设置',
            category_en: 'Global Settings',
        },
        // 客户端设置
